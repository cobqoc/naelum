...
test.describe('레시피 선택 재료·대체 재료', () => {
  test('인증 유저: 작성 폼에 "빼도 돼요" 토글 + 대체 재료 입력 노출', async ({ authenticatedPage: page }) => {
    ...
    // "빼도 돼요" visible 라벨 (2026-05-24 사용자 피드백: "없어도 OK" 영어 섞임 어색 → 자연 한국어)
    const optionalLabel = page.getByText(/빼도 돼요/).first()
