...
- `ingredients_master`: 907개 (dev 동기화 완료 2026-05-18; prod: 1,026개 — 2026-05-19 희귀/중복 정리 후 / other 0개)
...
- **ingredients_master 희귀·중복 재료 대규모 pending 처리** — 완료 (2026-05-19, prod DB 직접)
  ...
  - **prod 최종 분포**: veggie 204·seafood 164·grain 139·seasoning 137·condiment 130·fruit 82·meat 72·dairy 41·beverage 22·bakery 20·snack 15 = **1,026 approved** (pending 870개)
...
### 재료 DB
- **prod: 1,026개 approved** / **dev: 907개** (`ingredients_master`, 2026-05-19 희귀/중복 대규모 정리 후 — other 0개, pending 870개)
