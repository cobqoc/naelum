...
- `ingredients_master`: 1,896개 (데이터 품질 정리 완료 2026-05-18)
...
### 재료 DB
- **prod: 1,896개** / **dev: 958개** (`ingredients_master`, 2026-05-18 품질 정리 완료)
- `recipe_ingredients.ingredient_id` 커버리지: **prod 98.3%** (15,858/16,140) / **dev 82.4%** (17,114/20,760)
...
| 카테고리 | 채우기 방법 | 상태 |
|---|---|---|
| 재료 | ingredients_master DB 1,896개 (prod), description 86.0% 채움 완료 + 품질 정리 완료 | ✅ 재료 정보 입력+정리 완료 |
