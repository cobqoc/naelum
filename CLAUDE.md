...
- `ingredients_master`: **dev 281개 / prod 227개** (전부 approved, 2026-06-02 손질상태·중복·파싱쓰레기 전수 정리 후. 베이스 재료만 유지)
...
### 재료 DB
- **dev: 281개 / prod: 227개** (`ingredients_master`, 전부 approved, pending 0) — 2026-06-02 손질상태·중복·파싱쓰레기 전수 정리 완료. **베이스 재료만 유지**
...
| 카테고리 | 채우기 방법 | 상태 |
|---|---|---|
| 재료 | ingredients_master DB **prod 227개 / dev 281개** (베이스 재료만, 2026-06-02 손질상태·중복·파싱쓰레기 정리 완료). description 등 도감 상세 콘텐츠 현재 0개(재입력 필요) | ⬜ 도감 상세 콘텐츠 미보유 |
