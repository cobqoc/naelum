...
- **요리 도감 재료 정보 일괄 입력 완료** — 완료 (2026-05-18, prod DB 직접)
  ...
  - **커버리지**: 마스터 테이블 **1,637 / 1,990 = 82.3%** / 레시피 사용 기준 **15,532 / 16,059 = 96.7%**
...
### 재료 DB
- **prod: 1,990개** / **dev: 958개** (`ingredients_master`, 2026-05-18 기준)
- `recipe_ingredients.ingredient_id` 커버리지: **prod 89.7%** (31,957/35,641) / **dev 82.4%** (17,114/20,760)
- `description`(설명) 보유: **prod 1,637개 (82.3%)** — 2026-05-18 일괄 입력 완료
- `emoji` 보유: **prod 1,161개 (58.3%)**
- `name_en` 보유: 342개
...
| 카테고리 | 채우기 방법 | 상태 |
|---|---|---|
| 재료 | ingredients_master DB 1,990개 (prod), description 82.3% 채움 완료 | ✅ 재료 정보 입력 완료 |
...
|---|---|
| 이름/카테고리 | 100% |
| 설명(description) | **82.3%** (1,637/1,990) — 2026-05-18 일괄 입력 완료 |
| 보관법(storage_tips) | **82.3%** (description과 동시 입력) |
| 제철(seasons) | **82.3%** (description과 동시 입력) |
| 맛 프로파일(tastes) | **82.3%** (description과 동시 입력) |
| 어울리는 재료(pairs_well_with) | **82.3%** (description과 동시 입력) |
| 이모지(emoji) | 58.3% (1,161/1,990) |
