...
- `ingredients_master`: 907개 (dev 동기화 완료 2026-05-18; prod: 1,576개 — 2026-05-19 garbage 정리 후)
...
- **재료 카테고리 전면 정리 + 장보기 헤더 SVG 교체** — 완료 (2026-05-19, develop 푸시)
  ...
  - **i18n 업데이트**: `ingredient.categoryLabels.grain → 곡물류`, `dairy → 유제품·계란` (8 locale). dead key `dessert/asian` 제거. `cart.titleText` 추가
...
### 재료 DB
- **prod: 1,576개** / **dev: 907개** (`ingredients_master`, 2026-05-19 garbage 3단계+카테고리 통합 정리 완료)
