...
- `ingredients_master`: 907개 (dev 동기화 완료 2026-05-18; prod: 1,570개 — 2026-05-19 카테고리 전수 교정 후)
...
### 재료 DB
- **prod: 1,570개 approved** / **dev: 907개** (`ingredients_master`, 2026-05-19 garbage 3단계+카테고리 통합+전수 오분류 교정 완료)
