...
export const INGREDIENT_ALIASES: Record<string, string[]> = {
  ...
  '쇠고기': ['소고기', '한우', '우육', 'beef'],
  '돼지고기': ['돈육', '포크', '돼지 고기', '삼겹살', 'pork'],
  '삼겹살': ['돼지고기', '돈육', 'pork belly'],
  ...
  // 말린표고·건표고는 수분 90%+ 손실 + 풍미 농축 = 새 재료. ALIAS 부적절.
  '표고버섯': ['버섯'],
  '느타리버섯': ['버섯'],
  '팽이버섯': ['버섯'],
  '새송이버섯': ['버섯'],
  // 방울토마토는 다른 품종. 한·영 동의어만 유지.
  '토마토': ['tomato'],
  '오이': ['청오이'],
  '무': ['무우'],
  ...
  '가래떡': ['흰떡'],
  '흰떡': ['가래떡'],
  // 깐호두는 알맹이 동일이라 사실상 같지만, 정직성 기준에서 ALIAS 양방향은 무리.
  // 한·영 동의어만 유지.
  '호두': ['walnut'],
  // 알레르겐 견과류 한↔영 (식약처 알레르기 유발 표시)
  '땅콩': ['피넛', 'peanut'],
  '아몬드': ['almond'],
  '캐슈넛': ['cashew', '캐슈'],
  '잣': ['pine nut'],
