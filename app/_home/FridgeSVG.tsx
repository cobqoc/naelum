    ...
    <svg viewBox="30 -5 540 670" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <linearGradient id="interiorG" x1="0" y1="0" x2="0" y2="1">
          {/* 냉장실: 실제 냉장고 내부처럼 깔끔한 화이트 + 아주 옅은 그레이 틴트 (LED 켜진 듯한 느낌) */}
          <stop offset="0%" stopColor="#f4f8fa" />
          <stop offset="100%" stopColor="#c4d2d9" />
        </linearGradient>
        <linearGradient id="freezerG" x1="0" y1="0" x2="0" y2="1">
          {/* 냉동실: 살얼음 낀 듯 명확히 차가운 아이시 블루 — 냉장실보다 파랗게 */}
          <stop offset="0%" stopColor="#dfedf4" />
          <stop offset="100%" stopColor="#8fb2c3" />
        </linearGradient>
