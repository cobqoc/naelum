...
export default function FridgeSVG() {
  return (
    <svg viewBox="-30 -5 660 670" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* 금색 경계선 — 좌측 냉장 문 (외측 세로만) */}
      <path d="M 14,388 L 2,6 L 18,22 L 30,376 Z" fill="#E8C840" />
      <path d="M 2,6 L 18,22" fill="none" stroke="#F5E070" strokeWidth="1.2" opacity="0.6" />
      {/* 고무 패킹 */}
      ...
      {/* 금색 경계선 — 좌측 냉동 문 (외측 세로만) */}
      <path d="M 28,620 L 18,408 L 34,420 L 44,608 Z" fill="#E8C840" />
      <path d="M 18,408 L 34,420" fill="none" stroke="#F5E070" strokeWidth="1.2" opacity="0.6" />
      {/* 고무 패킹 */}
      ...
      {/* 금색 경계선 — 우측 냉장 문 (외측 세로만) */}
      <path d="M 568,22 L 584,10 L 582,388 L 566,376 Z" fill="#E8C840" />
      <path d="M 584,10 L 582,388" fill="none" stroke="#F5E070" strokeWidth="1.2" opacity="0.6" />
      {/* 고무 패킹 */}
      ...
      {/* 금색 경계선 — 우측 냉동 문 (외측 세로만) */}
      <path d="M 566,422 L 582,410 L 572,620 L 556,608 Z" fill="#E8C840" />
      <path d="M 582,410 L 572,620" fill="none" stroke="#F5E070" strokeWidth="1.2" opacity="0.6" />
      {/* 고무 패킹 */}
