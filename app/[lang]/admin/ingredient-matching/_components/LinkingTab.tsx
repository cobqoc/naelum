...
const CATEGORIES: { value: string; label: string }[] = [
  ...
  { value: 'legume', label: '콩류' }, { value: 'nuts', label: '견과류' },
  { value: 'fruit', label: '과일' },
  { value: 'fermented', label: '발효식품' }, { value: 'seasoning', label: '양념&소스' },
  { value: 'condiment', label: '조미료' }, { value: 'oil', label: '유지·기름' },
  { value: 'sweetener', label: '당류·감미료' }, { value: 'mushroom', label: '버섯류' },
  { value: 'seaweed', label: '해조류' }, { value: 'alcohol', label: '주류' },
  { value: 'seeds', label: '씨앗류' }, { value: 'spice', label: '향신료' },
