  ...
  return (
    <div ref={containerRef} className={`relative w-full ${className}`}>
      ...
      >
        ...
        <button
          type="submit"
          className={`flex-shrink-0 rounded-lg md:rounded-xl bg-accent-warm font-semibold text-background-primary transition-all hover:bg-accent-hover active:scale-95 !outline-none !border-0 ${
            isSmall
              ? 'mr-2 px-3 py-1.5 text-xs'
              : 'mr-2 md:mr-3 px-4 md:px-6 py-2 md:py-3 text-xs md:text-base'
          }`}
          style={{ border: 'none', borderLeft: 'none', borderRight: 'none' }}
        >
